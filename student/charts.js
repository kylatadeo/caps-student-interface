...
async function termGPA() {
  ...
  chart.draw(data, options);
   ...
   document.getElementById("termLabel").innerHTML = `<span class="txt-maroon">TERM ${firstTerm}</span> <span class="green pad-5 border-round12">Scholastic Standing: GOOD</span>`;
  ...
  google.visualization.events.addListener(chart, 'select', function () {
    ...
    if (selection.length > 0) {
        ...
        document.getElementById("termLabel").innerHTML = `<span class="txt-maroon">TERM ${term}</span> <span class="green pad-5 border-round12">Scholastic Standing: GOOD</span>`;
