...
function generateBtn() {
  const predefinedCourses = ["IE 199", "IE 158", "IE 165", "IE 185", "IE 200C", "MGT 131", "HK 12 (1)"];
    ...
    button.addEventListener("click", () => {
      ...
      predefinedCourses.forEach(courseCode => {
        if (typeof addToCoursePlan === 'function') {
          addToCoursePlan(courseCode);
        } else {
          console.warn('addToCoursePlan is not available yet.');
        }
      });
    })
  }
